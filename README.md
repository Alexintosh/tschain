...
A blockchain built in [TypeScript][typescript] [2.6][typescript-26] and [Node.js][nodejs] for educational purposes.
...
+ `dev` - starts nodemon, perfect for development (run watch in a different terminal)
